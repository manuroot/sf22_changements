jQuery(document).ready(function() {
 ...
 // Récupère le div qui contient la collection de tags
        ...
        var mybutton_add = '<button class="btn btn-small btn-primary"><i class="glyphicon glyphicon-plus"></i> Ajouter Fichier</button>';
        var mybutton_del = '<button class="btn btn-small btn-danger"><i class="glyphicon glyphicon-remove"></i> Supprimer Fichier</button>';
