...
class ChronoUsergroup
{
  ...
  /**
     ...
     * Add users
     *
     * @param \Application\RelationsBundle\Entity\ChronoUser $users
     * @return ChronoUsergroup
     */
    public function addUser(\Application\RelationsBundle\Entity\ChronoUser $users)
    {
        $this->users[] = $users;
     ...
     * @param \Application\RelationsBundle\Entity\ChronoUser $users
     */
    public function removeUser(\Application\RelationsBundle\Entity\ChronoUser $users)
    {
