...
; (function($) {
    var startHour = 7;
    var endHour = 21;
    var workDay = endHour - startHour;
    var fontSize = 22;
    var halfHour = fontSize;
    ...
    $.fn.bcalendar = function(option) {
        ...
        var __SCROLLEVENTTEMP = "<DIV style=\"WIDTH:${width};top:${top};left:${left};\" title=\"${title}\" class=\"chip chip${i} ${drag}\"><div class=\"dhdV\" style=\"display:none\">${data}</div><DIV style=\"BORDER-BOTTOM-COLOR:${bdcolor}\" class=ct>&nbsp;</DIV><DL style=\"BORDER-COLOR:${bdcolor}; BACKGROUND-COLOR:${bgcolor1}; HEIGHT: ${height}px;\"><DT style=\"BACKGROUND-COLOR:${bgcolor2}\">${starttime} - ${endtime} ${icon}</DT><DD><SPAN>${content}</SPAN></DD><DIV class='resizer' style='display:${redisplay}'><DIV class=rszr_icon>&nbsp;</DIV></DIV></DL><DIV style=\"BORDER-COLOR:${bdcolor}; BACKGROUND-COLOR:${bgcolor1}\" class=cb1>&nbsp;</DIV><DIV style=\"BORDER-COLOR:${bdcolor}\" class=cb2>&nbsp;</DIV></DIV>";
        ...
        function BuildDaysAndWeekView(startday, l, events, config) {
            ...
            html.push("<table style=\"height: ", tableHeight, "px\" id=\"tgTable\" class=\"tg-timedevents\" cellspacing=\"0\" cellpadding=\"0\"><tbody>");
        ...
        function BuildDayScollEventContainer(ht, dayarrs, events) {
            ...
            ht.push("><div id=\"tgspanningwrapper\" class=\"tg-spanningwrapper\"><div style=\"font-size:", fontSize, "px\" class=\"tg-hourmarkers\">");
            ...
            for (var i = startHour; i < endHour; i++) {
                ...
                ht.push("<div style=\"height: ", (fontSize * 2) + 1, "px\" class=\"tg-time\">", tmt, "</div>");
            }
            ht.push("</td>");
            var l = dayarrs.length;
            for (var i = 0; i < l; i++) {
                ...
                // Today
                if (istoday) {
                    ht.push("<div style=\"margin-bottom: -", tableHeight, "px; height:", tableHeight, "px\" class=\"tg-today\">&nbsp;</div>");
                }
                //var eventC = $(eventWrap);
                //onclick=\"javascript:FunProxy('rowhandler',event,this);\"
                ht.push("<div  style=\"margin-bottom: -", tableHeight, "px; height: ", tableHeight, "px\" id='tgCol", i, "' class=\"tg-col-eventwrapper\">");
        ...
        function BuildDayEvent(theme, e, index) {
            ...
            var newtemp = Tp(__SCROLLEVENTTEMP, p);
            p = null;
            return newtemp;
        }
                ...
                for (var h = 0; h < l; ) {
                    ...
                    if (e) { 
                        ...
                        if (!bs && j == (sc - 1) && z[h] < y[h]) {
                            el++;
                            $.extend(tempdata, { "axis": h, ch: "more", "abbr": dateFormat.call(cday[h], i18n.xgcalendar.dateformat.fulldayvalue), html: (y[h] - z[h]) + i18n.xgcalendar.others, click: "javascript:alert('more events');" });
                        ...
                        if (j == (sc - 1) && z[h] < y[h] && y[h] > 0) {
                            $.extend(tempdata, { "axis": h, ch: "more", "abbr": dateFormat.call(cday[h], i18n.xgcalendar.dateformat.fulldayvalue), html: (y[h] - z[h]) + i18n.xgcalendar.others, click: "javascript:alert('more event');" });
                            tempCss.push("st-more st-moreul");
                            h++;
                        }
                        else {
        ...
        function gP(h, m) {
            ...
            if (h > endHour)
                h = endHour;
            offset = h - startHour;
           return offset * oneHour + parseInt(m / 60 * oneHour);
        }
        function gW(ts1, ts2) {
            var t1 = ts1 / oneHour;
            var t2 = parseInt(t1);
            ...
            return { sh: t2 + startHour, sm: t3, eh: t5 + startHour, em: t6, h: ts2 - ts1 };
       }
        function gH(y1, y2, pt) {
            var sy1 = Math.min(y1, y2);
            var sy2 = Math.max(y1, y2);
            var t1 = (sy1 - pt) / oneHour;
            var t2 = parseInt(t1);
            var t3 = t1 - t2 >= 0.5 ? 30 : 0;
            var t4 = (sy2 - pt) / oneHour;
            var t5 = parseInt(t4);
            var t6 = t4 - t5 >= 0.5 ? 30 : 0;
            return { sh: t2 + startHour, sm: t3, eh: t5 + startHour, em: t6, h: sy2 - sy1 };
        }
        function pZero(n) {
            return n < 10 ? "0" + n : "" + n;
        }
        ...
        function tc(d) {
            function zc(c, i) {
                var d = 
                    "666666888888aaaaaabbbbbbdddddd"+
                    "a32929cc3333d96666e69999f0c2c2"+
                    "71062f8f193f993355eea2bbf5c7d6"+
                    "7a367a994499b373b3cca2cce1c7e1"+
                    "5229a36633cc8c66d9b399e6d1c2f0"+
                    "29527a336699668cb399b3ccc2d1e1"+
                    "2952a33366cc668cd999b3e6c2d1f0"+
                    "1b887a22aa9959bfb391d5ccbde6e1"+
                    "28754e32926265ad8999c9b1c2dfd0"+
                    "0d78131096184cb05288cb8cb8e0ba"+
                    "52880066aa008cbf40b3d580d1e6b3"+
                    "88880eaaaa11bfbf4dd5d588e6e6b8"+
                    "ab8b00d6ae00e0c240ebd780f3e7b3"+
                    "be6d00ee8800f2a640f7c480fadcb3"+
                    "b1440edd5511e6804deeaa88f5ccb8"+
                    "865a5aa87070be9494d4b8b8e5d4d4"+
                    "7057708c6d8ca992a9c6b6c6ddd3dd"+
                    "4e5d6c6274878997a5b1bac3d0d6db"+
                    "5a69867083a894a2beb8c1d4d4dae5"+
                    "4a716c5c8d8785aaa5aec6c3cedddb"+
                    "6e6e41898951a7a77dc4c4a8dcdccb"+
                    "8d6f47b08b59c4a883d8c5ace7dcce";
        ...
        function buildtempdayevent(sh, sm, eh, em, h, title, w, resize, thindex) {
            ...
            var newtemp = Tp(__SCROLLEVENTTEMP, {
                bdcolor: theme[0],
                bgcolor2: theme[0],
                bgcolor1: theme[2],
                data: "",
                ...
                icon: showIcons? "<I class=\"cic cic-tmr\">&nbsp;</I>" : "",
                top: "0px",
                left: "",
                width: w ? w : "100%",
                height: h,
        ...
        function getbuddlepos(x, y) {
            ...
            if (tleft <= 0 || ttop <= 0 || tleft + 400 > maxLeft) {
                ishide = true;
                // Squeeze in one more column
                if (ttop > 0 && tleft + 340 < maxLeft)
                    ishide = false;
                tleft = x - 200 <= 0 ? 10 : x - 200;
                ttop = y - 175 <= 0 ? y + oneHour + 10 : y - 175;
        ...
        function dayshow(e, data) {
            ...
            if (data != null) {
                if (option.quickDeleteUrl != "" && data[8] == 1 && option.readonly != true) {
                    var csbuddle = '<div id="bbit-cs-buddle" style="z-index: 180; width: 400px;visibility:hidden;" '
                        + 'class="bubble"><table class="bubble-table" cellSpacing="0" cellPadding="0"><tbody>'
                        + '<tr><td class="bubble-cell-side"><div id="tl1" class="bubble-corner">'
                        + '<div class="bubble-sprite bubble-tl"></div></div><td class="bubble-cell-main">'
                        + '<div class="bubble-top"></div><td class="bubble-cell-side">'
                        ...
                        + '<div><div></div><div class="cb-root"><table class="cb-table" cellSpacing="0" cellPadding="0">'
                        + '<tbody><tr><td class="cb-value"><div class="textbox-fill-wrapper">'
                        + '<div class="textbox-fill-mid"><div id="bbit-cs-what" title="'
                        + i18n.xgcalendar.click_to_detail + '" class="textbox-fill-div lk" style="cursor:pointer;">'
                        + '</div></div></div></td></tr><tr><td class=cb-value><div id="bbit-cs-buddle-timeshow">'
                        + '</div></td></tr></tbody></table><div class="bbit-cs-split"><input id="bbit-cs-id" '
                        + 'type="hidden" value=""/>[ <span id="bbit-cs-delete" class="lk">'
                        + i18n.xgcalendar.i_delete + '</span> ]&nbsp; <SPAN id="bbit-cs-editLink" class="lk">'
                        + i18n.xgcalendar.update_detail + ' <STRONG>&gt;&gt;</STRONG></SPAN></div></div></div></div>'
                        + '<tr><td><div id="bl1" class="bubble-corner"><div class="bubble-sprite bubble-bl"></div></div>'
                        + '<td><div class="bubble-bottom"></div><td><div id="br1" class="bubble-corner">'
                        + '<div class="bubble-sprite bubble-br"></div></div></tr></tbody></table>'
                        + '<div id="bubbleClose2" class="bubble-closebutton"></div>'
                        + '<div id="prong1" class="prong"><div class=bubble-sprite></div></div></div>';
                    ...
                    ss.push(dateFormat.call(data[2], i18n.xgcalendar.dateformat.Md));
                    if (data[4] != 1) {
                        ss.push(",", dateFormat.call(data[2], " HH:mm"));
                    }
                    if (iscos) {
                        ss.push(" - ", dateFormat.call(data[3], i18n.xgcalendar.dateformat.Md));
                        if (data[4] != 1) {
        ...
        function moreshow(mv) {
            ...
            var day = new Date(arrdays[2], parseInt(arrdays[1] - 1), arrdays[0]);
            var cc = $("#cal-month-cc");
            var ccontent = $("#cal-month-cc-content table tbody");
            var ctitle = $("#cal-month-cc-title");
            ctitle.html(dateFormat.call(day, i18n.xgcalendar.dateformat.Md));
            ccontent.empty();
            //var c = tc()[2];
            ...
            if (_dragdata) {
                ...
                switch (d.type) {
                    case 1:
                        ...
                        var y = e.pageY;
                        var diffy = y - sy;
                        if (diffy > qtrHour || diffy < -qtrHour || d.cpwrap) {
                            if (diffy == 0) { diffy = halfHour; }
                            var dy = diffy % halfHour;
                            if (dy != 0) {
                                diffy = dy > 0 ? diffy + (halfHour + 1) - dy : diffy - (halfHour + 1) - dy;
                                y = d.sy + diffy;
                                if (diffy < 0) {
                                    sy = sy + halfHour;
                                }
            ...
            if (_dragdata) {
                ...
                switch (d.type) {
                    case 1: //day view
                        ...
                        if (!d.cpwrap) {
                            var gh = gH(d.sy, d.sy + oneHour - 4, tp);
                            var ny = gP(gh.sh, gh.sm);
