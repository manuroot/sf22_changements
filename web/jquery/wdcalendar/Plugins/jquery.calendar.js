            ...
            for (var i = 0; i < l; i++) {
                ...
                if (istoday) {
                  /*    ht.push("<div style=\"margin-bottom: -1008px; height:1008px\" class=\"tg-today\">&nbsp;</div>");*/
                    ht.push("<div style=\"margin-bottom: -588px; height:588px\" class=\"tg-today\">&nbsp;</div>");
                }
                //var eventC = $(eventWrap);
                //onclick=\"javascript:FunProxy('rowhandler',event,this);\"
                ht.push("<div  style=\"margin-bottom: -588px; height: 588px\" id='tgCol", i, "' class=\"tg-col-eventwrapper\">");
...
function fomartTimeShow(h) {
 /* if( h > 12) { h = h - 12; return h < 10 ? "0" + h + ":00 PM" : h + ":00 PM"; } 
  else if(h == 0) { return "12:00 AM"; } 
  else if(h == 12) { return "12:00 PM"; } 
  else return h < 10 ? "0" + h + ":00 AM" : h + ":00 AM"; */
...
function quickadd(start, end, isallday, pos) {
    ...
    if (buddle.length == 0) {
        ...
        temparr.push('<td class="bubble-cell-main"><div class="bubble-top"></div>');
        temparr.push('<td class="bubble-cell-side"><div id="tr1" class="bubble-corner"><div class="bubble-sprite bubble-tr"></div></div>  <tr><td class="bubble-mid" colSpan="3"><div style="overflow: hidden" id="bubbleContent1"><div><div></div><div class="cb-root">');
        temparr.push('<table class="cb-table" cellSpacing="0" cellPadding="0">');
       temparr.push('<tbody>');
       temparr.push('<th colspan="2">Informations sur l\'evenement:</th>');
       /*Ajout pour les absences*/    
               temparr.push('<tr><th class="cb-key">Absence ?</th><td>');
        temparr.push('<div class="textbox-fill-mid"><input type="checkbox" id="absence" value="0"></input></div></td>');
        ...
        temparr.push(i18n.xgcalendar.content, ':</th><td class="cb-value"><div class="textbox-fill-wrapper">');

      
      temparr.push('<div class="textbox-fill-mid"><input id="bbit-cal-what" class="textbox-fill-input"/></div></div><div class="cb-example">');
    ...
    function() { 
       ...
       alert("Formulaire pour les absences");
        absence=1;
    } 
);
             /* var mycheck = $("#eventkoi").click(function() {
                if ($("#eventkoi").checked) { eventkoi=1;}else{eventkoi=0;}
              });*/
            if (!f) {
...
function ResizeView() {
    ...
    if (_viewType == "day" || _viewType == "week") {
     ...
     /*   var dvwkH = $dvwkcontaienr.height() + 100;*/
